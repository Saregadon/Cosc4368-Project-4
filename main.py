...
#print(SVPCV)
print("Poly kernel accuracy percentage {}%".format(svmpol*100))
...
#print(logisticMLPcv)
print("Logistic MPL accuracy percentage {}%".format(mlplogistics*100))
...
#print(TanhMLPcv)
print("Tanh MPL accuracy percentage {}%".format(fixmlp*100))
